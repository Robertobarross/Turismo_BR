...
<div id="search" align="center"><!-- Inicio da div search -->
    ...
    .busc{width: 60%; height: 40px; border-radius: 10px; margin-top: 15px; font-size: 20px; font-family: Arial;}/* Estilo da barra de pesquisa */
    .imglupa{width: 20px; margin-left: -30px; margin-top: 5px;}/* Estilo da lupa */
    </style><!-- Fim da estilização do formulário busc -->
</div><!-- Fim da div seach -->
