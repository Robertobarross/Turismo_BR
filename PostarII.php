...
<div id="Postar_right"><!-- Inicio da div postarII --> 

<?php  
    include 'connect.php'; // Faz a coneção com o banco de dados //

$sql = mysqli_query($link, "SELECT * FROM postagensII ORDER BY cidade DESC");// faz a consulta na tabela do bd //
...
?>
    ...
    #Postar_right{width: 49%; height: auto; float: right;}/* Estilo da div */
